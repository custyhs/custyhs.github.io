...
- 2026-09-10: the publication topic filter was removed at the author's request; the year navigation stays as plain anchor links and `_data/topics.yml` was deleted.
